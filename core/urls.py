...
urlpatterns = [
    ...
    path('dashboard/admin/scheduled-appointments/', views.scheduled_appointments_list, name='scheduled_appointments_list'),
    ...
    path('whatsapp/templates/', views.whatsapp_quick_replies_view, name='whatsapp_quick_replies'),
