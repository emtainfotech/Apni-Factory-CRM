...
WHATSAPP_SELLER_ONBOARDING_TEMPLATE = os.environ.get('WHATSAPP_SELLER_ONBOARDING_TEMPLATE', 'seller_onboarding_details_template')
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'no-reply@apnifactory.co.in')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', '')
